...
export default function WholesaleClientView({
  ...
  const assurances =
    settings?.wholesaleAssurances && Array.isArray(settings.wholesaleAssurances) && settings.wholesaleAssurances.length > 0
      ? settings.wholesaleAssurances
      ...
      <section className="section relative" data-hab-section="wholesale">
        ...
        <div className="pagehero">
          <div>
            ...
            <h1 className="display display--page">{settings?.wholesaleHeroTitle || 'Wholesale & Bulk Orders'}</h1>
            <p className="lede">
              {settings?.wholesaleHeroLede ||
