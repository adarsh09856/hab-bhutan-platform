...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#33261F] text-[#D2C2AE] pt-16 pb-[34px] mt-0">
      <div className="max-w-[1280px] min-w-[1200px] mx-auto px-10 grid grid-cols-[1.35fr_repeat(4,1fr)] gap-[34px]">
        <div>
          ...
          <p className="text-[14.5px] leading-[1.6] mb-[18px] max-w-[38ch] font-lora">
            ...
            <div className="flex flex-col gap-[9px]">
              {col.links.map((link) => (
                <Link
                  key={link.label}
                  href={link.href}
                  className="text-[14.5px] text-[#D2C2AE] hover:text-white transition-colors duration-150 font-lora"
                >
                  {link.label}
                </Link>
              ))}
      ...
      <div className="max-w-[1280px] min-w-[1200px] mx-auto mt-[34px] px-10 pt-[22px] border-t border-[#463629] flex justify-between font-mono text-[11px] flex-wrap gap-3 text-[#A8947F]">
        <span>
