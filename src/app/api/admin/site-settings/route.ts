...
export async function PUT(req: NextRequest) {
  ...
  try {
    const updatePayload: Record<string, any> = {
      ...
      ...(body.facebookUrl !== undefined && { facebookUrl: body.facebookUrl ? body.facebookUrl.trim() : null }),
      ...(body.instagramUrl !== undefined && { instagramUrl: body.instagramUrl ? body.instagramUrl.trim() : null }),
      ...(body.twitterUrl !== undefined && { twitterUrl: body.twitterUrl ? body.twitterUrl.trim() : null }),
      ...(body.youtubeUrl !== undefined && { youtubeUrl: body.youtubeUrl ? body.youtubeUrl.trim() : null }),
      ...(body.tiktokUrl !== undefined && { tiktokUrl: body.tiktokUrl ? body.tiktokUrl.trim() : null }),
    ...
    const createPayload: Record<string, any> = {
      ...
      facebookUrl: body.facebookUrl ? body.facebookUrl.trim() : null,
      instagramUrl: body.instagramUrl ? body.instagramUrl.trim() : null,
      twitterUrl: body.twitterUrl ? body.twitterUrl.trim() : null,
      youtubeUrl: body.youtubeUrl ? body.youtubeUrl.trim() : null,
      tiktokUrl: body.tiktokUrl ? body.tiktokUrl.trim() : null,
      ...
      aboutBandImageUrl: body.aboutBandImageUrl || '/assets/photos/about-hab.jpg',
      aboutBandImageCaption: body.aboutBandImageCaption || 'photo — HAB training workshop',
