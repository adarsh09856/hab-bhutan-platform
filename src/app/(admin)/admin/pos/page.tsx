...
export default function PosDecommissionedPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-16 px-4 text-center">
      ...
      <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-500 font-mono mb-8 flex items-center justify-center gap-2">
      ...
      <Link
        href="/admin/orders"
        className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#8B2E24] text-white text-sm font-semibold rounded-md shadow hover:bg-[#72241C] transition-colors"
      >
