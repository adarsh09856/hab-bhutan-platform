          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full p-6 shadow-xl border border-slate-200 space-y-5 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSave} className="space-y-4 text-sm">
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                />
                <label htmlFor="activeCheck" className="text-sm text-slate-800">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="px-5 py-2 bg-[#8B2E24] text-white font-semibold rounded-lg hover:bg-[#72251D] disabled:opacity-50 cursor-pointer flex items-center gap-2"
                >
          ...
          <tbody className="divide-y divide-slate-100">
            {crafts.map((c) => (
              <tr key={c.key} className="hover:bg-slate-50/80 transition-colors">
                ...
                <td className="px-5 py-4 font-serif text-base text-slate-700">
                  {c.dzongkha || '—'}
                </td>
                ...
                <td className="px-5 py-4 text-right">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 border border-slate-300 rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-100 cursor-pointer"
                  >
